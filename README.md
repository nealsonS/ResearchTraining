# Research Training
Lightweight object detection library for my Computer Vision research under Prof. Seon Kim
...
# Repo Directories
- `tracking`: mlflow tracking server setup/host
- `training`: research training library and experiments
